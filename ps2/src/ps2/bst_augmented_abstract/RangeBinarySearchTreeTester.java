...
public class RangeBinarySearchTreeTester {
	...
	public void testEmptyTreeCreation() {
		RangeBinarySearchTree tree = new RangeBinarySearchTree();
	...
	public void testCheckRep()
	{
		...
		{
			tree.checkRep();
			Assert.assertEquals("CheckRep success! Empty tree OK.", true, true);
		}
		catch(RuntimeException rEx)
		{
			//Should not hit this code
			Assert.assertEquals("CheckRep fail! Empty Tree not OK.", true, false);
		}
		...
		{
			tree.checkRep();
			Assert.assertEquals("CheckRep success! Tree with just root OK.", true, true);
		}
		catch(RuntimeException rEx)
		{
			//Should not hit this code
			Assert.assertEquals("CheckRep fail! Root only not OK.", true, false);
		}
		...
		{
			tree.checkRep();
			Assert.assertEquals("CheckRep success! Tree with structure is OK", true, true);
		}
		catch(RuntimeException rEx)
		{
			//Should not hit this code
			Assert.assertEquals("CheckRep fail! Tree with structure is not OK.", true, false);
		}
	}
}
